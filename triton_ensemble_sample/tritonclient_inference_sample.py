...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_name", type=str, default="ensemble_sample")
    ...
    # Sample input data
    input_datas = [
        np.array([[1, 2, 3]], dtype=triton_to_np_dtype(input_dtypes[0])),
        np.array([[10, 11, 23]], dtype=triton_to_np_dtype(input_dtypes[0])),
    ]
