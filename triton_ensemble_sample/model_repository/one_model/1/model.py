...
class TritonPythonModel:
    ...
    def execute(self, requests):
        ...
        for request in requests:
            input_1_tensor = pb_utils.get_input_tensor_by_name(request, "one_input")
            input_1_data = input_1_tensor.as_numpy()

            output_data = np.multiply(input_1_data, 3)
            output_tensor = pb_utils.Tensor("one_output", output_data.astype(self.output_dtypes[0]))
